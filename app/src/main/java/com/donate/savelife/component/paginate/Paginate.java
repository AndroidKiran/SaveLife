package com.donate.savelife.component.paginate;

import android.support.v7.widget.RecyclerView;

import com.donate.savelife.component.paginate.recycler.RecyclerPaginate;
...
public abstract class Paginate {
    ...
    public interface Callbacks {
         ...
         * {@link  com.donate.savelife.component.paginate.Paginate.Callbacks#onLoadMore} won't be called.
         *
         ...
         *  com.donate.savelife.component.paginate.Paginate.Callbacks#onLoadMore} won't be called and loading row, if used, won't be added.
         *
     ...
     * @return {@link  com.donate.savelife.component.paginate.recycler.RecyclerPaginate.Builder}
     */
     ...
     * @param callback    pagination callbacks.
     * @return {@link  com.donate.savelife.component.paginate.abslistview.AbsListViewPaginate.Builder}
     */
