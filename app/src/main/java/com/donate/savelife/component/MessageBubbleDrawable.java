package com.donate.savelife.component;
...
public class MessageBubbleDrawable extends Drawable {
    ...
    private void resolveDimensions(Resources resources) {
        messageBubblePadding = resources.getDimensionPixelSize(R.dimen.dimen_16);
        messageBubbleCornerRadius = resources.getDimensionPixelSize(R.dimen.dimen_16);
        bubbleCenterVertical = resources.getDimensionPixelSize(R.dimen.dimen_18);
        bumpDiameter = resources.getDimensionPixelSize(R.dimen.dimen_12);
        smallBubbleDiameter = resources.getDimensionPixelSize(R.dimen.dimen_6);
    }
