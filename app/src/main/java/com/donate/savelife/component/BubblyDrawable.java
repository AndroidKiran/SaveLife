...
public class BubblyDrawable extends Drawable{
    ...
    public BubblyDrawable(Resources resources) {
        this.bumpDiameter = resources.getDimensionPixelSize(R.dimen.dimen_24);
        this.smallBubbleDiameter = resources.getDimensionPixelSize(R.dimen.dimen_12);
        this.smallBubbleDistance = resources.getDimensionPixelSize(R.dimen.dimen_12);
