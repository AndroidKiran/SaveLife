 ...
 */
public class HonorHeroItemView extends RelativeLayout {
    ...
    public HonorHeroItemView(Context context) {
        super(context);
    }

    public HonorHeroItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            layoutResId = array.getResourceId(0, R.layout.merge_honor_item);
            array.recycle();
        }
    }
